...
`architectures` is the authoritative implementation: it reproduces the architectures exactly as
py` asserts each layer against the
sentence that specifies it. Prefer it over the older factories below.
"""
