...
| group | model | Spearman (mean) | Spearman (median) | MSE (mean) | MSE (median) |
|---|---|---|---|---|---|
| Baseline | RF | 0.7550 | 0.7554 | 0.0197 | 0.0195 |
...
The best performing model is `CNN_GRU+GC`, at a Spearman correlation of 0.8760 and a mean
squared error of 0.0093.
